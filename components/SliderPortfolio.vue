<template lang="pug">
div#coverpage(class="h-screen w-full bg-[#333533] absolute flex flex-col ")
    div#coverpage-navbar(class="flex flex-row justify-end w-full  items-center")
        Navbar( @click="$emit('close')")
        p(class="text-white px-8 text-xl hover:cursor-pointer bg-[#202020] h-[7rem] flex items-center" @click="$emit('close')") X
    div#coverpage-subnavbar
